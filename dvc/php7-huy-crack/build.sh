# Origin: https://github.com/termux/termux-packages/blob/62c7270dd3c1b3e677c84894a380ca53a83ca253/disabled-packages/php7/build.sh
TERMUX_PKG_HOMEPAGE=https://php.net
TERMUX_PKG_DESCRIPTION="Server-side, HTML-embedded scripting language"
TERMUX_PKG_LICENSE="PHP-3.0"
TERMUX_PKG_MAINTAINER="@Dichvucoder"
TERMUX_PKG_VERSION=7.4.33
TERMUX_PKG_SRCURL=https://github.com/u400822/iawnwie/raw/main/php-src-php-7.4.33.zip
TERMUX_PKG_SHA256=05e5e5573d7e45d6625984dc6e1b832ed2e05fa6d0b394f50b1443b320ee618e
...
termux_step_host_build() {
	(cd "$TERMUX_PKG_SRCDIR" && chmod +x * */* && ./buildconf --force)
